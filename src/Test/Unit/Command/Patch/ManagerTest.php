...
namespace Magento\SupportPatches\Test\Unit\Command\Patch;

use Composer\Package\RootPackageInterface;
use Magento\SupportPatches\Command\Apply;
use Magento\SupportPatches\Command\Patch\Manager;
use Magento\SupportPatches\Command\Patch\ManagerException;
use Magento\SupportPatches\Filesystem\DirectoryList;
use Magento\SupportPatches\Filesystem\FileList;
use Magento\SupportPatches\Filesystem\FileNotFoundException;
use Magento\SupportPatches\Filesystem\Filesystem;
use Magento\SupportPatches\Patch\Applier;
use Magento\SupportPatches\Patch\ApplierException;
...
class ManagerTest extends TestCase
{
    ...
    /**
     * @expectedException \Magento\SupportPatches\Command\Patch\ManagerException
